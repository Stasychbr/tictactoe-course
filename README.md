...
Примечание: будем обозначать поле _достаточно заполненным_, если пункт алгоритма 4 завершился неудачей `sqrt(M * N)` раз подряд. Высказывания "поле _достаточно заполненное_" и "поле _достаточно пустое_" являются противоложными.
